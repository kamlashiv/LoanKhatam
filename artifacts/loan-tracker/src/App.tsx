...
const clerkAppearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButtonText: "!text-lg !text-foreground !font-medium",
    formFieldLabel: "!text-lg !text-foreground !font-medium",
    ...
    formButtonPrimary: "!text-lg !py-4 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors",
