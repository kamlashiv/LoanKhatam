...
const clerkAppearance = {
  ...
  elements: {
    ...
    socialButtonsBlockButtonText: "!text-base !text-foreground !font-medium",
    formFieldLabel: "!text-base !text-foreground !font-medium",
    footerActionLink: "!text-base !text-primary !font-medium hover:underline",
    footerActionText: "!text-base !text-muted-foreground",
    dividerText: "!text-base !text-muted-foreground",
    identityPreviewEditButton: "!text-base text-primary",
    formFieldSuccessText: "!text-sm text-success",
    alertText: "!text-base text-foreground",
    logoBox: "hidden",
    logoImage: "h-12 w-auto",
    socialButtonsBlockButton: "!py-3 border-border hover:bg-secondary transition-colors",
    formButtonPrimary: "!text-base !py-3 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors",
    formFieldInput: "!text-base !py-3 border-border bg-input text-foreground focus:ring-ring rounded-md",
    footerAction: "mt-6",
