...
import { Wallet, ShieldCheck, TrendingUp, Users, ArrowUpRight, ArrowDownRight, CheckCircle2 } from "lucide-react";
...
export function SplitHero() {
  return (
    <div className="landing-root min-h-screen bg-background text-foreground flex flex-col overflow-hidden">
      {/* Header */}
            ...
            <div className="w-full max-w-md bg-card rounded-xl border border-border shadow-2xl overflow-hidden flex flex-col relative z-10 transform rotate-[-1deg] transition-transform hover:rotate-0 duration-500">
              ...
              <div className="px-5 py-4 border-b border-border bg-muted/30 flex justify-between items-center">
                <div>
                  ...
                  <div className="text-2xl font-bold font-mono tracking-tight">$4,250.00</div>
                </div>
              ...
              <div className="p-2 flex flex-col gap-1">
                <div className="p-3 rounded-lg flex items-center justify-between hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-sm">Mike's Car Repair</div>
                  ...
                  <div className="text-right">
                    <div className="font-bold text-sm font-mono">$1,200</div>
                ...
                <div className="p-3 rounded-lg flex items-center justify-between hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-sm">Sarah (Rent Share)</div>
                      <div className="text-xs text-muted-foreground flex items-center gap-1">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-sm font-mono">$850</div>
                ...
                <div className="p-3 rounded-lg flex items-center justify-between hover:bg-muted/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-sm">Dave's Startup</div>
                  ...
                  <div className="text-right">
                    <div className="font-bold text-sm font-mono">$2,200</div>
      ...
      {/* Features: Horizontal Row / Scroll feel */}
